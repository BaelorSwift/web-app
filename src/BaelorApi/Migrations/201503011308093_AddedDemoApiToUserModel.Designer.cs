...
namespace BaelorApi.Migrations
{
    ...
    public partial class AddedDemoApiToUserModel : IMigrationMetadata
    {
        string IMigrationMetadata.MigrationId
        {
            get
            {
                return "201503011308093_AddedDemoApiToUserModel";
            }
        }
        ...
        IModel IMigrationMetadata.TargetModel
        {
            get
            {
                ...
                builder.Entity("BaelorApi.Models.Database.Song", b =>
                    {
                        b.ForeignKey("BaelorApi.Models.Database.Lyric", "LyricId");
